...
.project-footer-meta{display:flex;align-items:center;flex-wrap:wrap;gap:8px;color:#7786a2;font:600 10px var(--mono)}
.project-footer-meta span:not(:last-child):after{content:'·';margin-left:8px;color:#b1bacb}
